<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_MsgC.aspx.cs" Inherits="Admin_AuctionDetails" %>
...
<section id="intro" class="intro">
    ...
    <section id="services" class="home-section  bg-gray">
            ...
            <h2 style="text-align:center"> Auction Message for Customer </h2>
 ...
 <table align="center">
                      ...
                      <tr>
                          <td>
                               <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Black" Text="Customer"></asp:Label>
                          </td>
                    <td class="auto-style1">
                              ...
                              <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [username], [Category], [Sub_Category], [Bid], [transportername] FROM [Description]"></asp:SqlDataSource>
                          </td>
                      </tr>

                      <tr>
                          <td>
                               <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Black" Text="Customer"></asp:Label>
                          </td>
                          <td>
                              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical">
                                  ...
                                  <Columns>
                                      <asp:CommandField ShowSelectButton="True" />
                                      <asp:BoundField DataField="Email_Id" HeaderText="Username" SortExpression="Email_Id" />
                              ...
                              <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Customer_Name], [Contact_No], [Email_Id] FROM [Cust_Reg]"></asp:SqlDataSource>
                          </td>
                      </tr>

                      <tr>
                          <td>
                              <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Black" Text="Customer Name"></asp:Label>
                          </td>
                          <td>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:TextBox ID="txt_ccno" runat="server"></asp:TextBox>
                          </td>
                      </tr>
                      <tr>
                          <td>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:TextBox ID="txt_Scat" runat="server"></asp:TextBox>
                          </td>
                      </tr>
     <tr>
         <td>

             <asp:Label ID="Label7" runat="server" Font-Bold="True" ForeColor="Black" Text="Bid"></asp:Label>
     ...
     <tr>
         <td>
             ...
             <asp:Label ID="Label8" runat="server" Font-Bold="True" ForeColor="Black" Text="Transporter Name"></asp:Label>

         </td>
         <td>

             <asp:TextBox ID="txt_trans" runat="server"></asp:TextBox>
